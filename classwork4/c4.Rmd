...
plot.with.dif.point.and.a <- function(a = 0.15,clear.row = 0){
  ...
  p.plot <- plot(pcgmp~pop, data=gmp, xlab="Население", log="xy",ylab="Доход на душу населения ($/человеко-год)", main="Метрополии США, 2006")
  print(paste("a:",estimate.scaling.exponent(a)[[1]],"iterations:", estimate.scaling.exponent(a)[[2]]))
  print(p.plot)
  print(lines(gmp$pop, gmp$predicted, col = "red"))
}
```
